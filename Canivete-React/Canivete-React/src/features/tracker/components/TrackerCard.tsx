                    ...
                    <Box minWidth={'6rem'}>
                        <Flex direction={'column'} gap={'3'}>
                            ...
                            <Flex direction={'row'} gap={'4'}>
                                <Button color={habit.color} onClick={() => markToday(habit)} >Concluir Hoje</Button>
                                <Button color={habit.color} variant="outline" onClick={() => unmarkToday(habit)}>Desmarcar Hoje</Button>
